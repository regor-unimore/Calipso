...
#test parameters
seeds = [3, 91, 572, 103, 4246, 9999, 19873, 14593, 75380, 91704]
        ...
        for k in range(n_iter):
            ...
            while tf < 3600:
                ...
                if obj_prec == obj:
                    ...
                    ilim = 0  # VND
                    coeff = coeff_0  # VND
                    test.append([index, coeff, obj, tm1, tm2, time.time()-t0]) #model._incumbenttime,
            ...
            g = open(f"4_Solutions/{ttype}_{coeff_0}_{step}_randomVND_{gra}_{L}_{nCat}.txt", "a")
            ...
            f = open(f"4_Solutions/{ttype}_{coeff_0}_{step}_randomVND(sol)_{gra}_{L}_{nCat}.txt", "a")
            f.write(f'Objective Value = {obj} \n')
            for i in selected:
                f.write("%d\n" % i)
            f.close()

        f = open(f"4_Solutions/{ttype}_{coeff_0}_{step}_randomVND_{gra}_{L}_{nCat}.txt", "a")
