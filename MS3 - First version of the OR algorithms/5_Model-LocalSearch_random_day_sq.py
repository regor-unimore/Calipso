    ...
    for L in [134]:#,67,134,268]:
        ...
        for k in range(n_iter):
            ...
            while tf < 3600:
                ...
                day_fix = {day[i]: 0 for i in range(nP)}
            ...
            g = open(f"4_Solutions/{ttype}_{coeff_0}_{step}_random_day_{gra}_{L}_{nCat}_score2,5.txt", "a")
            ...
            f = open(f"4_Solutions/{ttype}_{coeff_0}_{step}_random_day(sol)_{gra}_{L}_{nCat}_score2,5.txt", "a")
            f.write(f'Objective Value = {obj} \n')
            for i in selected:
                f.write("%d\n" % i)
            f.close()

        f = open(f"4_Solutions/{ttype}_{coeff_0}_{step}_random_day_{gra}_{L}_{nCat}_score2,5.txt", "a")
