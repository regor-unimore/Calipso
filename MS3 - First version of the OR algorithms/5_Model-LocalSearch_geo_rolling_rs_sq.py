...
#test parameters
seeds = [9, 54, 782, 533, 8371, 2759, 27803, 44093, 89350, 11604]
...
for gra in [3000, 2000, 1000]: # , 5000, 3000, 2000, 1000]:
    ...
    for L in [134]:  # ,134,268]:
        ...
        # ######################## MODEL EXECUTION ###############################
        for ttype in ['MR', 'LR', 'VLR']:  # , 'HR', 'MR', 'LR', 'VLR']:
            ...
            for k in range(n_iter):
                ...
                g = open(f"4_Solutions/{ttype}_{coeff_0}_{step}_geo_rolling_rsVND_{gra}_{L}_{nCat}.txt", "a")
                ...
                f = open(f"4_Solutions/{ttype}_{coeff_0}_{step}_geo_rolling_rsVND(sol)_{gra}_{L}_{nCat}.txt", "a")
                f.write(f'Objective Value = {obj} \n')
                for i in selected:
                    f.write("%d\n" % i)
                f.close()

            f = open(f"4_Solutions/{ttype}_{coeff_0}_{step}_geo_rolling_rsVND_{gra}_{L}_{nCat}.txt", "a")
